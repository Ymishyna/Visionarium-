...
const Home = () => {
    ...
    return (
        <section className="max-w-7xl mx-auto">
            <div>
                <h1 className="font-extrabold text-gray-900 text-4xl">The Community Showcase</h1>
                <p className="mt-4 text-gray-600 text-lg max-w-2xl">Browse through a collection of imaginative and visually stunning images generated by DALL-E AI</p>
            </div>
